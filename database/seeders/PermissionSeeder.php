...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'bookings.delete']);
            ...
            //permission for system hotel
        Permission::create(['name' => 'manage countries']);
        Permission::create(['name' => 'manage cities']);
        Permission::create(['name' => 'manage hotels']);
        Permission::create(['name' => 'manage hotel bookings']);
        Permission::create(['name' => 'checkout hotels']);
        Permission::create(['name' => 'view hotel bookings']);
    }
}
