...
<section id    = "content" class                                                       = "max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-white overflow-x-hidden relative">
    <div     class = "w-full h-[230px] flex shrink-0 overflow-hidden">
        <img     src   = "{{asset('')}}frontend/assets/images/backgrounds/signup-bg.png" class = "object-cover w-full h-full" alt = "background">
    </div>
    @if ($errors->any)
    ...
    <form action = "{{route('register')}}" method="POST" enctype="multipart/form-data" class = "flex flex-col justify-between flex-1 px-[18px] pt-8 pb-6">
        ...
        <div  class  = "flex flex-col gap-8">
            ...
            <div  class = "flex flex-col gap-6">
                <div  id    = "Pay-proof" class                                                                                                                                                                                                                         = "flex flex-col gap-2 bg-white rounded-xl">
                    ...
                    <div  class = "flex flex-col gap-2 input-container">
                        ...
                        <div  class = "group flex items-center gap-2 p-[12px_16px] border border-[#DCDFE6] rounded-lg overflow-hidden">
                            ...
                            <input type = "text" name = "name" id = "name" value="{{ old('name') }}" class = "appearance-none outline-none w-full bg-white placeholder:text-[#757C98] placeholder:font-medium text-sm font-semibold" placeholder = "Enter your name" required>
                        </div>
                    </div>
                    <div class = "flex flex-col gap-2 input-container">
                        ...
                        <div class="group flex items-center gap-2 p-[12px_16px] border border-[#DCDFE6] rounded-lg overflow-hidden">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}" class="appearance-none outline-none w-full bg-white placeholder:text-[#757C98] placeholder:font-medium text-sm font-semibold" placeholder="example@gmail.com" required>
                        </div>
                    </div>
                    <div class="flex flex-col gap-2 input-container">
