    ...
    <div id="Details-content" class="flex flex-col">
      <header class="flex flex-col">
        <div id="thumbnail-container" class="grid grid-cols-3 gap-[3px]">
          <a id="Main-thumbnail" href="{{asset('')}}uploads/{{$hotel->thumbnail}}" class="col-span-3 glightbox w-full aspect-[393/247] overflow-hidden" data-gallery="gallery1" >
            <img src="{{asset('')}}uploads/{{$hotel->thumbnail}}" class="object-cover w-full h-full" alt="thumbnail">
          </a>
          @foreach ($latesphotos as $item)
          <a href="{{asset('')}}uploads/{{$item->photo}}" class="glightbox w-full aspect-[129/90] overflow-hidden" data-gallery="gallery1" >
        ...
        <div id="Hotel-info" class="bg-white p-[24px_18px] flex flex-col gap-2">
          <div id="Hotel-rating" class="flex items-center gap-[6px]">
            ...
            <div class="flex items-center gap-1 ratings-container">
              <div class="flex items-center star-container">
                ...
                <div class="flex shrink-0 w-[18px] h-[18px] p-[2px]">
                  <img src="{{asset('')}}frontend/assets/images/icons/Star-half.svg" alt="star">
                </div>
              </div>
          ...
          <div id="Hotel-Location" class="flex items-center gap-1">
            <div class="flex w-6 h-6 shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/location-grey.svg" alt="icon">
            </div>
      ...
      <div id="Facilities" class="bg-white p-[24px_18px] flex flex-col gap-3 mt-2">
        ...
        <div class="card-container grid grid-cols-2 gap-[18px]">
          <a href="" class="card-facilities">
            <div class="border border-[#DCDFE6] bg-white p-4 rounded-lg flex flex-col gap-6">
              <div class="flex w-12 h-12 overflow-hidden rounded-lg shrink-0">
                <img src="{{asset('')}}frontend/assets/images/icons/gym.svg" alt="icon">
              </div>
          ...
          <a href="" class="card-facilities">
            <div class="border border-[#DCDFE6] bg-white p-4 rounded-lg flex flex-col gap-6">
              <div class="flex w-12 h-12 overflow-hidden rounded-lg shrink-0">
                <img src="{{asset('')}}frontend/assets/images/icons/free-wifi.svg" alt="icon">
              </div>
              <div class="flex flex-col gap-[2px]">
          ...
          <a href="" class="card-facilities">
            <div class="border border-[#DCDFE6] bg-white p-4 rounded-lg flex flex-col gap-6">
              <div class="flex w-12 h-12 overflow-hidden rounded-lg shrink-0">
                <img src="{{asset('')}}frontend/assets/images/icons/room-service.svg" alt="icon">
              </div>
              <div class="flex flex-col gap-[2px]">
          ...
          <a href="" class="card-facilities">
            <div class="border border-[#DCDFE6] bg-white p-4 rounded-lg flex flex-col gap-6">
              <div class="flex w-12 h-12 overflow-hidden rounded-lg shrink-0">
                <img src="{{asset('')}}frontend/assets/images/icons/swimming-pool.svg" alt="icon">
              </div>
              <div class="flex flex-col gap-[2px]">
              ...
              <div class="customer flex items-center justify-between gap-[18px]">
                <div class="flex items-center gap-2 customer-info">
                  <div class="flex overflow-hidden rounded-full profile-pic w-9 h-9 shrink-0">
                    <img src="{{asset('')}}frontend/assets/images/photos/pic1.png" class="object-cover w-full h-full" alt="profile picture">
                  </div>
          ...
          <a href="" class="testimonial-card pl-[18px] last:pr-[18px]">
            <div class="bg-white rounded-lg p-4 flex flex-col gap-4 w-[308px]">
              <div class="customer flex items-center justify-between gap-[18px]">
                <div class="flex items-center gap-2 customer-info">
                  <div class="flex overflow-hidden rounded-full profile-pic w-9 h-9 shrink-0">
                    <img src="{{asset('')}}frontend/assets/images/photos/pic2.png" class="object-cover w-full h-full" alt="profile picture">
                  </div>
                  <div class="flex flex-col">
...
@push('after-script')
 <!-- JavaScript -->
  ...
  <script src = "{{asset('')}}frontend/js/hotel-details.js"></script>
