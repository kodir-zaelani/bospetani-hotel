...
<section id    = "content" class                                                  = "max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-[#F8F8F8] overflow-x-hidden pb-[122px] relative">
    <div     class = "w-full h-[233px] absolute top-0 overflow-hidden">
        <img     src   = "{{asset('')}}frontend/assets/images/backgrounds/BG-1.png" class = "object-cover w-full h-full" alt = "backgrounds">
    </div>
    <div class = "relative z-10 px-[18px] flex flex-col gap-6 mt-[60px]">
        ...
        <form method="POST" action="{{route('front.search.hotels')}}" class= "flex flex-col gap-6 p-4 bg-white rounded-xl">
            @csrf
            <div  class  = "flex flex-col gap-4 input-container">
            ...
            <div  class = "flex flex-col gap-4">
                <div  class = "flex flex-col gap-4 input-container">
                    ...
                    <div  class = "relative group flex items-center gap-2 p-[12px_16px] border border-[#DCDFE6] rounded-lg overflow-hidden">
                        ...
                        <input type = "date" name = "checkin_at" id = "checkIn" class = "absolute bottom-0 opacity-0" required>
                    </div>
                </div>
                <div  class = "flex flex-col gap-4 input-container">
                    ...
                    <div  class = "relative group flex items-center gap-2 p-[12px_16px] border border-[#DCDFE6] rounded-lg overflow-hidden">
                        ...
                        <input type = "date" name = "checkout_at" id = "checkOut" class = "absolute bottom-0 opacity-0" required>
                    </div>
                </div>
            </div>
            <button type="submit" class= "!bg-[#4041DA] p-[12px_24px] h-12 flex items-center gap-3 rounded-lg justify-center">
                <div    class = "flex shrink-0">
                    <img    src   = "{{asset('')}}frontend/assets/images/icons/search-normal.svg" alt = "icon">
                </div>
