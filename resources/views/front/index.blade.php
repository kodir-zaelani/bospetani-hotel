...
<body class="font-poppins text-[#070625]">
  <section id="content" class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-[#F8F8F8] overflow-x-hidden pb-[122px] relative">
    <header class="flex justify-center h-[376px] px-[18px] relative overflow-hidden -mb-[106px]">
      <img src="{{asset('')}}frontend/assets/images/backgrounds/BG.png" class="absolute object-cover w-full h-full" alt="backgrounds">
        ...
        <nav class="bg-white p-[10px_16px] h-fit w-full flex items-center justify-between rounded-full shadow-[0_8px_30px_0_#0A093212] z-10 mt-[60px]">
          <a href="{{route('login')}}">
            <div class="w-[54px] h-[54px] flex shrink-0 overflow-hidden rounded-full items-center justify-center">
              <img src="{{asset('')}}frontend/assets/images/icons/user.svg" class="object-cover w-full h-full" alt="icon">
            </div>
          </a>
          <div class="flex flex-col gap-[2px] text-center">
            ...
            <div class="flex items-center justify-between gap-1">
              <div class="flex shrink-0">
                <img src="{{asset('')}}frontend/assets/images/icons/location.svg" alt="icon">
          ...
          <a href="">
            <div class="w-[54px] h-[54px] flex shrink-0 overflow-hidden rounded-full items-center justify-center">
              <img src="{{asset('')}}frontend/assets/images/icons/Notifcations.svg" alt="icon">
            </div>
          </a>
        </nav>
      </div>
    ...
    <div id="Feature" class="px-[18px] relative z-10">
      <div class="bg-white p-[18px_16px] rounded-xl overflow-hidden grid grid-cols-4 gap-[27px]">
        <a href="{{route('front.hotels')}}">
          <div class="flex flex-col items-center gap-2">
            <div class="w-[60px] h-[60px] flex shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/Hotel.png" class="object-cover" alt="icon">
            </div>
        ...
        <a href="">
          <div class="flex flex-col items-center gap-2">
            <div class="w-[60px] h-[60px] flex shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/Flight.png" class="object-cover" alt="icon">
            </div>
        ...
        <a href="">
          <div class="flex flex-col items-center gap-2">
            <div class="w-[60px] h-[60px] flex shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/Train.png" class="object-cover" alt="icon">
            </div>
        ...
        <a href="">
          <div class="flex flex-col items-center gap-2">
            <div class="w-[60px] h-[60px] flex shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/Bus.png" class="object-cover" alt="icon">
            </div>
        ...
        <a href="">
          <div class="flex flex-col items-center gap-2">
            <div class="w-[60px] h-[60px] flex shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/Ferry.png" class="object-cover" alt="icon">
            </div>
        ...
        <a href="">
          <div class="flex flex-col items-center gap-2">
            <div class="w-[60px] h-[60px] flex shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/Finance.png" class="object-cover" alt="icon">
            </div>
        ...
        <a href="">
          <div class="flex flex-col items-center gap-2">
            <div class="w-[60px] h-[60px] flex shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/Travel.png" class="object-cover" alt="icon">
            </div>
        ...
        <a href="">
          <div class="flex flex-col items-center gap-2">
            <div class="w-[60px] h-[60px] flex shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/View All.png" class="object-cover" alt="icon">
            </div>
    ...
    <div id="Promo" class="flex flex-col w-full gap-3 py-6 mt-6 overflow-hidden bg-white">
      ...
      <div class="main-carousel">
        <a href="" class="pl-[18px] last:pr-[18px]">
          <div class="flex flex-col gap-4 w-fit">
            <div class="w-[310px] h-[160px] flex shrink-0 overflow-hidden rounded-xl">
              <img src="{{asset('')}}frontend/assets/images/thumbnails/thumbnail1.png" class="object-cover w-full h-full" alt="thumbnail">
            </div>
        ...
        <a href="" class="pl-[18px] last:pr-[18px]">
          <div class="flex flex-col gap-4 w-fit">
            <div class="w-[310px] h-[160px] flex shrink-0 overflow-hidden rounded-xl">
              <img src="{{asset('')}}frontend/assets/images/thumbnails/thumbnail2.png" class="object-cover w-full h-full" alt="thumbnail">
            </div>
            <div class="flex flex-col gap-1">
        ...
        <a href="" class="pl-[18px] last:pr-[18px]">
          <div class="flex flex-col gap-4 w-fit">
            <div class="w-[310px] h-[160px] flex shrink-0 overflow-hidden rounded-xl">
              <img src="{{asset('')}}frontend/assets/images/thumbnails/thumbnail3.png" class="object-cover w-full h-full" alt="thumbnail">
            </div>
            <div class="flex flex-col gap-1">
    ...
    <div id="Menu-bar" class="fixed bottom-[24px] px-[18px] max-w-[640px] w-full z-30">
      <div class="bg-white p-[14px_12px] rounded-full flex items-center justify-center gap-8 shadow-[0_8px_30px_0_#0A093212]">
        <a href="{{route('front.index')}}">
          <div class="flex flex-col items-center gap-1">
            <div class="flex w-6 h-6 shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/home-active.svg" alt="icon">
            </div>
        ...
        <a href="">
          <div class="flex flex-col items-center gap-1">
            <div class="flex w-6 h-6 shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/search-nonactive.svg" alt="icon">
            </div>
        ...
        <a href="">
          <div class="flex flex-col items-center gap-1">
            <div class="flex w-6 h-6 shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/activity-nonactive.svg" alt="icon">
            </div>
        ...
        <a href="">
          <div class="flex flex-col items-center gap-1">
            <div class="flex w-6 h-6 shrink-0">
              <img src="{{asset('')}}frontend/assets/images/icons/settings-nonactive.svg" alt="icon">
            </div>
