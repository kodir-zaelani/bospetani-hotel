...
<section id    = "content" class = "max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-[#F8F8F8] overflow-x-hidden pb-6 relative">
    ...
    <div class = "relative z-10 px-[18px] flex flex-col gap-6 mt-[60px]">
        ...
        <div id = "result" class = "result-card-container flex flex-col gap-[18px]">
            ...
            <a   href  = "{{route('front.hotels.details', $item)}}">
                <div class = "flex flex-col overflow-hidden bg-white card-result rounded-xl">
                    ...
                    <div class = "flex flex-col gap-6 p-4 content-container">
                        <div class = "details-container flex flex-col gap-[6px]">
                            ...
                            <p   class = "font-semibold hotel-name">{{$item->name}}</p>
                            <div class = "flex items-center gap-3 badge">
                                <div class = "flex items-center gap-1">
                                    <div class = "flex shrink-0">
                                        <img src   = "{{asset('')}}frontend/assets/images/icons/location-grey.svg" alt = "icon">
                                    </div>
                                    <p class = "font-medium text-sm leading-[21px] text-[#757C98]"> {{$item->city->name}}, {{$item->country->name}}</p>
                                </div>
                                <div class = "flex items-center gap-1">
                                    <div class = "flex shrink-0">
                                        <img src   = "{{asset('')}}frontend/assets/images/icons/star-outline-grey.svg" alt = "icon">
                                    </div>
                                    <p class = "font-medium text-sm leading-[21px] text-[#757C98]">{{$item->star_level}}  Star</p>
                                </div>
                                <div class = "flex items-center gap-1">
                                    <div class = "flex shrink-0">
                                        <img src   = "{{asset('')}}frontend/assets/images/icons/wifi-grey.svg" alt = "icon">
                                    </div>
                        ...
                        <div class = "total-price flex gap-[2px] items-center">
                            <p   class = "text-[#54A917] font-semibold text-lg leading-[27px]">Rp {{number_format($item->getLowesRoomPrice(), 0, ',', '.')}}/night</p>
            ...
            <div id    = "result" class= "result-card-container flex flex-col gap-[18px]">
                <div class = "empty-result h-[321px] bg-white rounded-xl overflow-hidden flex flex-col justify-center items-center gap-3">
                    <div class = "flex shrink-0 w-9 h-9">
                        <img src   = "{{asset('')}}frontend/assets/images/icons/emoticon.png" alt = "icon">
                    </div>
